...
return [
    ...
    'Home' => 'Inicio',
    'Invalid data received for parameter "{param}".' => 'Datos erróneos recibidos para el parámetro "{param}"',
    'Login Required' => 'Login requerido',
    'Missing required arguments: {params}' => 'Faltan argumentos requeridos: {params}',
    ...
    'Please upload a file.' => 'Por favor, seleccione un archivo a subir.',
    ...
    'Unable to verify your data submission.' => 'No ha sido posible de verificar los datos enviados.',
    'Unknown option: --{name}' => 'Opción desconocida: --{name}',
    'Update' => 'Actualizar',
    'View' => 'Ver',
    'Yes' => 'Sí',
    'You are not allowed to perform this action.' => 'No tiene permisos suficientes para realizar esta acción.',
